...
1. **Erklären**, warum Gesundheitsmythen sich online schnell verbreiten und welche Mechanismen dabei eine Rolle spielen.
2. **Anwenden** der QQQQ-Methode zur Überprüfung von Gesundheitsbehauptungen.
...
5. **Entwickeln** einer kritisch-reflektierten Haltung gegenüber Gesundheitsinformationen aus dem Netz.
...
- **LH19 – Körperbilder im Internet:** Unrealistische Körperideale, Bildmanipulation (werden als bekannt vorausgesetzt; direkter Bezug in Phase 3).
- **LH8 – Digital stark:** Ernährung, Bewegung, Schlaf als Grundthemen (werden vorausgesetzt).
- **LH7 – Die Welt der Influencer:innen:** Werbung vs. Information, kommerzielle Interessen (werden vorausgesetzt; direkter Bezug in Phasen 3 und 4).
...
**QQQQ-Methode:** Diese Methode ist das didaktische Herzstück der Einheit. Sie sollte in Phase 2 sorgfältig eingeführt werden – die Gruppenarbeit funktioniert nur, wenn die Methode vorher klar ist. Alternativbezeichnung möglich: „Vier Fragen vor dem Glauben".
...
**Grundschule (Kl. 3–4):** GS-Erweiterungen sind in Phase 1 (Detektiv-Geschichte) und Phase 2 (Detektiv-Arbeitsblatt). Sie ersetzen die jeweiligen Sek-Aufgaben vollständig. Kein Vorwissen über Social Media oder Ernährungswissenschaft erforderlich.
...
Vorwissen aktivieren, persönliche Relevanz herstellen, Neugier wecken; Mechanismen der Verbreitung von Gesundheitsmythen verstehen, Verbindung zu Körperbildern und psychischer Gesundheit herstellen
...
Die Schnellabfrage und der Kurzimpuls werden durch eine **Detektiv-Geschichte im Sitzkreis** ersetzt. Die Bildcollage mit Social-Media-Behauptungen entfällt.
...
**Ziel:** Das Stille-Post-Prinzip als Alltagsbild einführen – eine Aussage wandert weiter, ohne dass jemand nachfragt. Das ist keine Lüge, aber es ist auch keine Prüfung. Diese Einsicht bereitet den Detektiv-Ansatz in Phase 2 vor.

**Kein Kurzvideo, keine Infografik, kein AB 1** – nur Erzählung und Gespräch.

**Zeitumfang:** ca. 15 Minuten (Phase 1 wird in der Grundschule entsprechend gekürzt; die gewonnene Zeit fließt in Phase 2)
...
**Warum Einstieg und Hinführung zusammen?**
Die Frage „Glaubst du das?" (Einstieg) und die Frage „Warum glaubt man das?" (Hinführung) greifen unmittelbar ineinander. Eine Trennung würde den Gedankenfluss unterbrechen. Die 25 Minuten dieser Doppelphase sind inhaltlich eng verknüpft.
...
*Aufgreifen:* Die Unsicherheit bei einzelnen Behauptungen thematisieren – „Woher käme man, wenn man sicher sein wollte?" → Brücke zu Phase 2.
...
Praktische Methoden zur Überprüfung von Gesundheitsbehauptungen kennenlernen und anwenden; verstehen, dass Faktencheck eine erlernbare Kompetenz ist, die Gesundheit schützt
...
- Eigene Kurzrecherche (5 Min.) bei verfügbaren Geräten
...
Statt der QQQQ-Methode und der Gruppen-Faktenarbeit (zu abstrakt) arbeiten die Kinder mit dem **Primarstufe – Detektiv-Arbeitsblatt**.
...
**Zeitumfang:** ca. 20 Minuten (Zeit aus der verkürzten Phase 1 genutzt)
...
**Warum Gruppenarbeit?**
Faktencheck ist diskursiver Prozess. In der Gruppe werden verschiedene Einschätzungen sichtbar – „Ich finde die Quelle glaubwürdig" vs. „Ich nicht" – und regen zur Begründung an.
...
## Phase 4: Vertiefung – Wer steckt dahinter? (10 Min.)
...
Phasen 2 und 3 haben gezeigt, *was* Gesundheitsmythen sind und wie sie funktionieren. Phase 4 fragt nach dem *Warum* – und macht damit die strukturelle Dimension sichtbar: Mythen sind kein Zufall, sondern oft Produkt von kommerziellen Interessen und algorithmischen Verstärkern.
...
Nach einer inhaltlich dichten Einheit mit praktischen Methoden, Gruppenarbeit und Quiz braucht es bewusst Raum zum Innehalten. Die Reflexionsrunde signalisiert: Was du heute mitgenommen hast, ist wertvoll – auch wenn du es noch nicht ganz in Worte fassen kannst.
...
1. **Nicht alles, was viral geht, ist wahr** – Gesundheitsmythen verbreiten sich online besonders schnell, weil sie einfache Lösungen versprechen und Emotionen ansprechen.
...
3. **Wissenschaftliche Quellen erkennen schützt** – Wer Fakten von Mythen unterscheiden kann, trifft bessere Gesundheitsentscheidungen.
4. **Kritisches Denken ist Gesundheitsschutz** – Die QQQQ-Methode ist kein Misstrauen gegenüber allem, sondern ein Werkzeug für informierte, selbstbestimmte Entscheidungen.

---

*DURCHBLICKT! | LH3 – Lerneinheit | Stand: April 2026*
