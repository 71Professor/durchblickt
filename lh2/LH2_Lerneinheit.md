...
1. **Erklären**, dass digitale Identität konstruiert und kuratiert ist – niemand zeigt sich online vollständig.
2. **Analysieren**, welche Gestaltungsentscheidungen hinter Online-Profilen stecken und welche psychologischen Bedürfnisse sie erfüllen.
3. **Erkennen**, wie soziale Vergleiche mit kuratierten Profilen Selbstbild und Wohlbefinden beeinflussen.
4. **Unterscheiden** zwischen Selbstausdruck (authentisch) und Selbstinszenierung (strategisch) – und den fließenden Übergängen.
5. **Entwickeln** eigener Strategien für eine bewusste, gesunde Online-Präsenz.

---

## Voraussetzungen & Anknüpfungspunkte

Die Lerneinheit baut auf folgenden Vorkenntnissen auf:

- **LH1 – KI & menschliche Bedürfnisse:** Grundverständnis von Datenschutz und Identitätsbegriff (wird in Phase 1 kurz aktiviert, nicht wiederholt).
- **LH29 – Selbstwahrnehmung:** Grundbegriffe Selbstbild, Selbstwert (werden vorausgesetzt).
- **LH19 – Körperbilder im Internet:** Bildmanipulation, unrealistische Darstellungen (werden als bekannt vorausgesetzt; direkter Bezug in Phase 4).
- **LH14 – Challenges:** Algorithmen, Social-Media-Mechanismen, Gruppendruck (werden vorausgesetzt; Bezug in Phase 2).
- **LH7 – Die Welt der Influencer:innen:** Inszenierungsstrategien, Authentizitätsfragen (werden vorausgesetzt; Bezug in Phase 3).

---

## Hinweise für die Lehrkraft

**Sensibilität:** Das Thema berührt das Selbstbild der Lernenden direkt. Viele haben persönliche Erfahrungen mit sozialen Vergleichen, Perfektionsdruck oder Selbstwertproblemen. Ziel ist Reflexion – nicht Bewertung von Online-Verhalten. Wichtig: Nicht moralisieren. Die Kernbotschaft ist nicht „Social Media ist schlecht", sondern „Wie gehe ich bewusst damit um?"

**Anonymität wahren:** Bei der Kartenabfrage (Phase 1) und dem Selbstreflexionsbogen (AB 4, Phase 6) gilt: Alles bleibt anonym und muss nicht geteilt werden. Darauf explizit hinweisen – vor allem bei Sek I.

**Differenzierung:** Sek I und Sek II arbeiten mit denselben Materialien. Die Differenzierung erfolgt durch gezielte Impulsfragen und Zusatzaufgaben (siehe jeweilige Phase).

**Grundschule (Kl. 3–4):** Die GS-Erweiterungen in Phase 1 und Phase 3 ersetzen die entsprechenden Sek-Aufgaben vollständig. Grundschulkinder benötigen kein Vorwissen über Social Media.

**Technische Vorbereitung:** Für die Kartenabfrage (Phase 1) empfiehlt sich ein digitales Tool (Padlet, Mentimeter) oder physische Karten. Für Phase 3 werden die fiktiven Profile (AB 2) als Ausdrucke oder via Beamer benötigt.
...
Thema emotional aktivieren, Vorwissen sichtbar machen, Bewusstsein für die Konstruiertheit digitaler Identität wecken
...
- Fokus auf eigene, vertraute Plattformen (Instagram, TikTok, Snapchat, WhatsApp-Status)
- Impulsfragen in einfacher, konkreter Sprache: *„Was postest du? Was würdest du nie posten?"*
- Kartenabfrage: Plattformnamen genügen als Antwort
- Noch keine Fachbegriffe einführen

**Sek II (Kl. 11–13):**

- Zusätzliche Plattformen: LinkedIn, Xing, persönliche Websites, berufliche Kontexte
- Impulsfragen erweitern: *„Welches Profil würdest du deiner zukünftigen Chefin zeigen? Welches deinen Mitschüler:innen?"*
- Begriffe „Selbstdarstellung" und „Impression Management" (Goffman) können bereits im Einstieg fallen gelassen werden – als Vorverweis auf Phase 2
- Kartenabfrage: Plattform + kurze Funktionsbeschreibung
...
- Auf anonyme Kartenabfrage wird verzichtet – stattdessen kurze mündliche Runde im Sitzkreis
- Überleitung: *„Heute schauen wir, warum das so ist – und was das mit uns macht."*

**Materialhinweis:** Einfaches Schwarz-Weiß-Bilderpaar (A4, projizierbar oder ausgedruckt). Keine aufwändige Produktion notwendig – eine skizzenhafte Zeichnung genügt.
...
- Das Startervideo ist eine *Idee* – wenn es noch nicht produziert wurde, kann die Lehrkraft die Collage auch mündlich beschreiben oder selbst erstellen (4 Screenshots eines fiktiven Profils)

**Lernpsychologischer Hintergrund:**
Der Einstieg nutzt das Prinzip der kognitiven Aktivierung durch Widerspruch. Die Spannung zwischen „alle Profile sind echt" und „sie zeigen etwas Verschiedenes" motiviert zur weiteren Auseinandersetzung und aktiviert vorhandenes Alltagswissen über Selbstdarstellung.
...
4. **WhatsApp-Status** – gezielt für bestimmte Kontakte
5. **Gaming-Profile** – Nutzername, Avatar, Spielstatistiken
6. **YouTube** – Kommentare, ggf. eigener Kanal

*Aufgreifen:* Antworten, die zeigen, dass Schüler:innen verschiedene Versionen von sich auf verschiedenen Plattformen zeigen → direkte Brücke zu Phase 2.
...
Mechanismen der Online-Selbstdarstellung verstehen, die 5 Bausteine digitaler Identität kennenlernen, Gestaltungsentscheidungen als psychologische Entscheidungen erkennen
...
**Warum die 5-Bausteine-Struktur?**
Das Modell ist bewusst einfach gehalten – es soll nicht technisch erklären, wie Social Media funktioniert, sondern analytische Kategorien bereitstellen. Die fünf Bausteine helfen Schüler:innen, das intuitiv Bekannte explizit zu machen: *„Ich wähle mein Profilbild sorgfältig aus"* wird zu einer bewussten Erkenntnis über Selbstdarstellung.
...
- Selbstwert: positives Feedback von außen
...
Selbstdarstellungsstrategien und deren psychologische Hintergründe erkennen, verschiedene Strategien vergleichen und einordnen
...
Statt AB 2 (Analyse fiktiver Social-Media-Profile) arbeiten die Lernenden mit **Primarstufe AB 1** – einem kindgerechten Analysebogen mit vier gezeichneten Kinder-Avataren.

**Inhalt Primarstufe AB 1:**
...
- Optional: Kinder dürfen selbst in den AB-Avataren etwas ausfüllen – *„Was würdest du über dich schreiben?"*
...
**Warum drei Typen?**
Die drei Typen – „Der Perfekte", „Der Authentische", „Der Kreative" – sind keine Werturteile, sondern Analysekategorien. Sie machen sichtbar, dass Selbstdarstellungsstrategien vielfältig sind und je nach Kontext und Bedürfnis variieren. Das verhindert eine simplizierende Botschaft à la „authentisch = gut, inszeniert = schlecht".

**Das Authentizitätsparadox (Sek II):**
„Authentizität" ist selbst eine Strategie: Das sorgfältig ausgewählte „zufällige" Selfie, der gezielt ungefilterte Post – die Grenze zwischen Selbstausdruck und Selbstinszenierung ist fließend. Das ist kein Problem, das gelöst werden soll, sondern ein Phänomen, das reflektiert werden soll.
...
Auswirkungen von Online-Selbstdarstellung auf Selbstbild, Wohlbefinden und mentale Gesundheit erkennen; soziale Vergleiche als psychologischen Mechanismus verstehen
...
- Bezug zu LH19 (Körperbilder): Soziale Vergleiche sind nicht neu – Social Media verstärkt sie
...
- Auf Beratungsangebote hinweisen, falls Gespräche persönlich werden (BARMER-Angebote, schulpsychologische Dienste)

**Lernpsychologischer Hintergrund:**
Fallarbeit fördert das Transferdenken: Schüler:innen wenden das in Phase 2 und 3 erworbene Wissen auf konkrete Situationen an. Die Kurzvorstellung im Plenum schult Perspektivwechsel und argumentative Auseinandersetzung.
...
Konkrete Handlungsstrategien für eine bewusste, gesunde Online-Präsenz entwickeln; persönliche Haltung festigen
...
**Transfer ≠ Reflexion:**
Diese Phase ist bewusst handlungsorientiert: Es geht darum, das Gelernte in konkrete Überlegungen zu übersetzen. Die Meinungslinie ist kein Test, die „5 Fragen" sind keine Regeln. Ziel ist, dass Schüler:innen eine eigene Haltung entwickeln – nicht eine vorgegebene übernehmen.

**Warum Meinungslinie?**
Die körperliche Positionierung im Raum macht abstrakte Meinungen sichtbar und erleichtert die Verbalisierung: Wer schon steht, hat eine Position – jetzt muss sie nur noch begründet werden. Die Meinungslinie visualisiert außerdem die Vielfalt von Haltungen im Klassenraum.

**Warum persönlicher Vorsatz anonym?**
...
*Aufgreifen:* Die letzte Antwort-Kategorie ist besonders wertvoll – sie zeigt Medienkompetenz und schützt vor falschen Schlüssen (Nicht-Zeigen ≠ Unehrlichkeit).
...
4. Bereue ich das vielleicht später?
...
4. Was bleibt davon in 5 Jahren?
5. Was lasse ich bewusst weg – und ist das okay?
...
Rückblick auf den Lernprozess; kein Handlungsdruck, kein Produkt, kein Bewertungsdruck
...
Phase 6 ist einheitlich für Sek I und Sek II. Niedrigschwellig, offen, ohne Bewertungsdruck.

**Grundschule:** Abschlussrunde im Sitzkreis, gleiche Impulsfragen in kindgerechter Sprache: *„Was hast du heute gelernt? Was hat dich überrascht?"*

### Didaktischer Kommentar

**Reflexion ≠ Transfer:**
Diese Phase ist bewusst offen gehalten. Es geht nicht darum, nochmals Erkenntnisse zu sichern oder Handlungsoptionen zu benennen – das war Phase 5. Reflexion bedeutet: Innehalten, ohne Erwartung an ein Ergebnis. Offene Fragen dürfen offen bleiben.

**Warum kein Auflösungsgespräch?**
...
- AB 4 nie als Pflicht einfordern
...
Langzeitwirkung der Lerneinheit überprüfen, persönliche Entwicklung im Umgang mit der eigenen Online-Präsenz reflektieren
...
Das Follow-up ist explizit optional. Es entfaltet seinen Wert nur, wenn die Lernenden sich tatsächlich an die Stunde erinnern und etwas mitgenommen haben. Es sollte nicht als Test oder Evaluation der Stunde gerahmt werden, sondern als echtes Gespräch über Alltag und Veränderung.
...
*DURCHBLICKT! | LH2 – Lerneinheit | Stand: April 2026*
